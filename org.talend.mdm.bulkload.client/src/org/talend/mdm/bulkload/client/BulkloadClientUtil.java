...
public class BulkloadClientUtil {
    ...
    public static void bulkload(String url, String cluster, String concept, String datamodel, boolean validate, boolean smartpk,
        ...
        RequestConfig requestConfig = RequestConfig.custom()
                ...
                .setResponseTimeout(getClientTimeout(CLIENT_SOCKET_TIMEOUT))
        ...
        InputStreamEntity content = new InputStreamEntity(itemdata, -1, ContentType.TEXT_XML);
    ...
    private static Timeout getClientTimeout(String property) throws Exception {
